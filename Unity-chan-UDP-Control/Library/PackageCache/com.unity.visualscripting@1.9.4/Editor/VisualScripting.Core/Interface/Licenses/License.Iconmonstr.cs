namespace Unity.VisualScripting
{
    ...
    {
        public const string Iconmonstr = @"This license agreement (the “Agreement E sets forth the terms by which Alexander Kahlkopf, the owner of iconmonstr (the “Licensor E, shall provide access to certain Work (defined below) to you (the “Licensee E “you Eor “your E. This Agreement regulates the free use of the icons, fonts, images and other media content (collectively, the “Work E, which is made available via the website iconmonstr.com (the “Website E. By downloading or copying a Work, you agree to be bound by the following terms and conditions.
...
The Website and the Works are provided “as is. ELicensor does not accept any warranty or liability regarding a Work, the Website, the accuracy of the information or rights described therein or the licenses, which are subject to this Agreement. Licensor is not liable for damages, costs, losses or claims incurred by you, another person or entity by the use of the Website or the Works.";
    }
}
