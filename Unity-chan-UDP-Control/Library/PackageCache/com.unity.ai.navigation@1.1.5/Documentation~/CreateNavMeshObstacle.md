...
- [NavMesh Obstacle component reference](https://docs.unity3d.com/Manual/class-NavMeshObstacle.html)  Efull description of all the NavMesh Obstacle properties.
