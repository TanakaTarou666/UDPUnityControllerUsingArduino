...
namespace UnityEngine.UI
{
    ...
    public class Button : Selectable, IPointerClickHandler, ISubmitHandler
    {
        ...
        ///
        /// 3. If Submit doesn’t exist, add 1 number to the Size field. This creates a new section at the bottom. Expand the new section and change the Name field to “Submit E
        ///
