...
namespace UnityEngine.UI
{
        ...
        ILayoutElement
    {
        ...
        /// <summary>
        /// This is an optional ‘empty Egraphic to show that the InputField text field is empty. Note that this ‘empty' graphic still displays even when the InputField is selected (that is; when there is focus on it).
