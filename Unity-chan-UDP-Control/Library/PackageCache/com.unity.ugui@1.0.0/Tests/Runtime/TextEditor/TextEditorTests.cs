...
public class TextEditorTests
{
    ...
    static IEnumerable textWithCodePointBoundaryIndices
    {
        get
        {
            ...
            //
            yield return new TestCaseData("Hello �E World", new[] { 0, 1, 2, 3, 4, 5, 6, 8, 9, 10, 11, 12, 13, 14 }).SetName("Hello (U+1F601) World");
            yield return new TestCaseData("見ざる🙈、聞かざる🙉、言わざる🙁E, new[] { 0, 1, 2, 3, 5, 6, 7, 8, 9, 10, 12, 13, 14, 15, 16, 17, 19 }).SetName("Three wise monkeys");
            */
        }
    }
    ...
    static IEnumerable textWithWordStartAndEndIndices
    {
        get
        {
            ...
            yield return new TestCaseData("Hello �E World", new[] { 0, 6, 9 }, new[] { 5, 8, 14 }).SetName("Hello (U+1F601) World");
            yield return new TestCaseData("見ざる🙈、聞かざる🙉、言わざる🙁E, new[] { 0, 3, 6, 10, 13, 17 }, new[] { 3, 6, 10, 13, 17, 19 }).SetName("Three wise monkeys");
            */
        }
    }
